...
int busca_binaria(int *dados, int limite_esquerda, int limite_direita, int valor) {    
    ...
    if (dados[index_meio] == valor) //caso base 2
       ...
       return busca_binaria(dados, index_meio + 1, limite_direita, valor);

    else 
       return busca_binaria(dados, limite_esquerda, index_meio - 1, valor);
